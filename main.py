...
class VQADataset(torch.utils.data.Dataset):
    def __init__(self, df_path, image_dir, processor=None, answer=True):
        ...
        if self.answer:
            ...
            for add_answers in self.addition_answer['answer']:
...
class VQAModel(nn.Module):
    ...
    def forward(self, images, questions):
        ...
        text_features, (_, _) = self.text_encoder(questions)
...
def main():
    ...
    for epoch in range(num_epoch):
        ...
        torch.save(model.state_dict, f'./models/clip_vit16p_2/clip_epoch{epoch+1}.pth')
        ...
        print(f"====================Val===================="
            ...
            f"Val simple acc: {val_simple_acc:.4f}", flush=True)
        ...
        #ensure_make_dir_os(f"./rn50_linear/rn50_embed")
        np.save(f"./submission/clip_vit16p_2/submission_epoch{epoch+1}.npy", submission)
